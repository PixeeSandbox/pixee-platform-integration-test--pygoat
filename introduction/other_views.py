...
def cmd_lab3(request):
    if request.user.is_authenticated:
        if (request.method=="POST"):
            ...
            # Validate that domain only contains allowed characters (alphanumerics, hyphens, and dots)
            # TODO: Adjust the regex pattern to match the expected domain format if needed
