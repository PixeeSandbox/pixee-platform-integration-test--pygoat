    ...
    if request.user.is_authenticated:
        if (request.method=="POST"):
            ...
            if not re.match(r'^[A-Za-z0-9.-]+$', domain):
                # TODO(developer): Replace "Error: Invalid domain" with the appropriate error message or handling
                return render(request, 'Lab/CMD/cmd_lab.html', {"output": "Error: Invalid domain"})
