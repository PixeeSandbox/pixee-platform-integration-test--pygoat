...
# Accept only plain hostnames/domains after lightweight URL prefix normalization.
...
def _is_valid_domain(domain):
    return bool(domain) and len(domain) <= 253 and bool(DOMAIN_RE.fullmatch(domain))
