...
def cmd_lab3(request):
    if request.user.is_authenticated:
        if (request.method=="POST"):
            ...
            if not re.match(r'^[a-zA-Z0-9.-]+$', domain):  # TODO(developer): Adjust regex as needed for valid domain names
                raise ValueError('Invalid domain input')  # TODO(developer): Customize error handling as appropriate
