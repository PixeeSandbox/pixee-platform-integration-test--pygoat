...
def cmd_lab3(request):
    if request.user.is_authenticated:
        if (request.method=="POST"):
            ...
            print(os)
            if(os=='win'):
                command = ['nslookup', domain]  # TODO: Validate 'domain' against allowed hostname patterns
            else:
                command = ['dig', domain]  # TODO: Validate 'domain' against allowed hostname patterns
            try:
