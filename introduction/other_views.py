    ...
    if request.user.is_authenticated:
        if (request.method=="POST"):
            ...
            if not re.match(r'^[A-Za-z0-9.-]+$', domain):
                # TODO: Replace this error handling with the appropriate handling mechanism
                return render(request, 'Lab/CMD/cmd_lab.html', {"output": "Invalid domain value provided."})
