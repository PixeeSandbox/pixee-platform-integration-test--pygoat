...
def cmd_lab3(request):
    if request.user.is_authenticated:
        if (request.method=="POST"):
            ...
            print(os)
            # Mitigation for command injection vulnerability: using list arguments and shell set to False. Consider validating 'domain' parameter using a regular expression.
            if(os=='win'):
