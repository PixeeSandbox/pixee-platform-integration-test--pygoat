...
def cmd_lab3(request):
    if request.user.is_authenticated:
        if (request.method=="POST"):
            ...
            # Validate domain to ensure it only contains alphanumeric characters, dots, and hyphens
            ...
            try:
                ...
                # Execute the command without using shell to prevent command injection
