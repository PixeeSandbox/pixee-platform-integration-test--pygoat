...
def cmd_lab3(request):
    if request.user.is_authenticated:
        if (request.method=="POST"):
            ...
            # Validate domain against allowed characters (letters, digits, hyphen, and dot)
            valid_domain_pattern = r'^[a-zA-Z0-9.-]+$'
            if not re.fullmatch(valid_domain_pattern, domain):
