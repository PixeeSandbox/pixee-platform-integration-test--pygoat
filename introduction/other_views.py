...
def cmd_lab3(request):
    if request.user.is_authenticated:
        if (request.method=="POST"):
            ...
            print(os)
                        # Basic whitelist validation for domain input - replace with your own validation logic as needed
            if not re.match(r'^[a-zA-Z0-9.-]+$', domain):
                # Placeholder: implement proper error handling for invalid domain
