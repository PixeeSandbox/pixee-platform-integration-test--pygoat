...
# Validate domain to allow only alphanumerics, dots, and hyphens
if not re.match(r'^[a-zA-Z0-9.-]+$', domain):
    # TODO(developer): Replace 'Invalid domain input' with a more descriptive error message if needed
