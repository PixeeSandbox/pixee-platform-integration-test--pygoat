...
def cmd_lab3(request):
    if request.user.is_authenticated:
        if (request.method=="POST"):
            ...
            print(os)
            # TODO(developer): Add proper domain validation/sanitization as needed
            if not re.match(r'^[a-zA-Z0-9\-.]+$', domain): # TODO(developer): Adjust the regex pattern if necessary
