...
LOOKUP_TARGET_RE = re.compile(r'^(?=.{1,253}\.?$)(?:[A-Za-z0-9](?:[A-Za-z0-9-]{0,61}[A-Za-z0-9])?(?:\.[A-Za-z0-9](?:[A-Za-z0-9-]{0,61}[A-Za-z0-9])?)*)\.?$')
...
def _is_valid_lookup_target(domain):
    ...
    try:
        ...
        return bool(LOOKUP_TARGET_RE.fullmatch(domain))
