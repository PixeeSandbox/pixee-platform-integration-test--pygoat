...
def cmd_lab3(request):
    if request.user.is_authenticated:
        if (request.method=="POST"):
            ...
            # Keep this allowlist strict; only plain hostnames/domains should be permitted.
            ...
            print(os)
            if(os=='win'):
                command_vZEbHSxU=['nslookup', domain]
            else:
                command_vZEbHSxU = ['dig', domain]
            try:
                # output=subprocess.check_output(command_vZEbHSxU,shell=True,encoding="UTF-8")
