...
def cmd_lab3(request):
    if request.user.is_authenticated:
        if (request.method=="POST"):
            ...
            # Domain validation: ensure only allowed characters are present. Adjust error message as necessary.
            ...
            try:
                ...
                # Execute command securely using subprocess.Popen with shell=False
